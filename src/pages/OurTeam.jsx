...
const OurTeam = () => {
  return (
    <div className="max-w-6xl mx-auto mb-10 pt-20 px-2">
      ...
      <p className="text-gray-700 text-lg sm:text-xl leading-relaxed text-center max-w-3xl mx-auto mb-10">
      ...
      <div className="grid gap-8 md:grid-cols-3">
        <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center text-center border-t-4 border-green-600">
          ...
          <p className="text-gray-600 text-base mb-3">Visionary leader with 15+ years in IT consulting. John is passionate about building high-performing teams and delivering innovative solutions that drive client growth and satisfaction.</p>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center text-center border-t-4 border-blue-600">
          ...
          <p className="text-gray-600 text-base mb-3">Priya specializes in talent acquisition and career development. She is dedicated to connecting top IT professionals with opportunities that match their skills and aspirations.</p>
          <div className="flex space-x-3 justify-center">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center text-center border-t-4 border-purple-700">
          ...
          <p className="text-gray-600 text-base mb-3">Alex leads our technology strategy and innovation. He is committed to delivering scalable solutions and driving digital transformation for our clients.</p>
          <div className="flex space-x-3 justify-center">
